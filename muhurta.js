...
const ACTIONS = {
  ...
  jobQuit: {
    ...
    roles: { tarabala: 'Благоприятно', specialDay: 'Ограничение', tithi: 'Контекст', vara: 'Контекст', nakshatra: 'Контекст', dasha: 'Контекст' },
    favorableNakGana: null,
    restrictedNakGana: null,
    // Черновик, самый неопределённый из трёх новых: это действие по природе —
    // завершение, а не начинание, а для "завершений" классические правила
    // мухурты (какие титхи/накшатры благоприятны) proработаны намного слабее,
    // чем для начинаний. Пока не решаю за неё Ограничение/Благоприятно по
    // титхи/накшатре — оставила Контекст, чтобы не выдумывать.
  },
  conception: {
    label: 'Зачатие (планирование)',
    roles: { tithi: 'Ограничение', nakshatra: 'Ограничение', specialDay: 'Ограничение', tarabala: 'Благоприятно', vara: 'Контекст', chandraBala: 'Контекст', dasha: 'Контекст' },
    favorableNakGana: ['Стхира', 'Мриду'],
    restrictedNakGana: ['Угра', 'Тикшна'],
    // Важная оговорка: классический раздел про зачатие (Гарбхадхана Мухурта)
    // гораздо специфичнее общих правил начинаний — там учитываются отдельные
    // подробные таблицы титхи/накшатр именно под эту тему, и это не то же
    // самое, что общие "хорошие титхи для начинаний". Здесь — по общему
    // каркасу начинаний, как временное приближение, не как точный расчёт
    // по этому конкретному разделу.
  },
};
